...
public class DriverForAreaAndVolQuang {
    ...
    public static void main(String[] args){
        MyMethod.myHeader(4,2,"Calculates information about cylinders and cones.");
        //Header message
        ...
        System.out.println("The cone with the maximum volume is " + maxVolume(cone) + " cubic cm");//Prints out highest volume of all cones
        MyMethod.myFooter(2);
        //Sign-off message
    }
}
